...
file_path = "../01 Data/PreETL_PovertyUSAStates.csv"
...
measures <- c("PopulationPolled","PopulationBelowPovertyLVL","WhitePopulation","BlackPopulation","LatinoHispanic","WhitePopulationBelowPovertyLVL","BlackPopulationBelowPovertyLVL","LatinoHispanicBelowPovertyLVL")
